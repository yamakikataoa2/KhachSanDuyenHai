...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roomTypeIds = [];
        $roomTypes = [
            ['TenLoai' => 'Phòng Deluxe', 'MoTa' => 'Phòng Deluxe sang trọng 35m², view thành phố, trang bị đầy đủ tiện nghi cao cấp. Nội thất tinh tế, giường king-size êm ái và phòng tắm marble hiện đại.', 'SoNguoiToiDa' => 2, 'GiaMacDinh' => 2500000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800&q=80'],
            ['TenLoai' => 'Phòng Suite Imperial', 'MoTa' => 'Suite rộng rãi 65m² với phòng khách riêng, bồn tắm Jacuzzi và ban công panorama. Không gian lý tưởng cho kỳ nghỉ lãng mạn.', 'SoNguoiToiDa' => 3, 'GiaMacDinh' => 5800000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&q=80'],
            ['TenLoai' => 'Presidential Suite', 'MoTa' => 'Trải nghiệm đỉnh cao 120m² — phòng ngủ master, phòng khách, bếp riêng, và dịch vụ quản gia 24/7.', 'SoNguoiToiDa' => 4, 'GiaMacDinh' => 12000000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&q=80'],
            ['TenLoai' => 'Ocean View Room', 'MoTa' => 'Phòng hướng biển 40m², đón bình minh mỗi sáng từ giường ngủ comfort, ban công riêng.', 'SoNguoiToiDa' => 2, 'GiaMacDinh' => 3200000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=800&q=80'],
            ['TenLoai' => 'Garden Villa', 'MoTa' => 'Villa riêng biệt 85m² giữa vườn nhiệt đới, hồ bơi riêng, không gian hoàn toàn yên tĩnh.', 'SoNguoiToiDa' => 4, 'GiaMacDinh' => 7500000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1602002418816-5c0aeef426aa?w=800&q=80'],
            ['TenLoai' => 'Family Suite', 'MoTa' => 'Phòng gia đình rộng rãi 75m² với 2 phòng ngủ, khu vui chơi trẻ em và tiện nghi cho cả nhà.', 'SoNguoiToiDa' => 5, 'GiaMacDinh' => 4500000, 'AnhDaiDien' => 'https://images.unsplash.com/photo-1566665797739-1674de7a421a?w=800&q=80'],
        ];
        ...
        $bookings = [
            ['MaKH' => $customerIds[0], 'MaGoi' => $combo1Id, 'NgayDat' => '2026-04-08', 'NgayNhan' => '2026-04-15', 'NgayTra' => '2026-04-18', 'TrangThai' => 'Đã xác nhận', 'GhiChu' => 'Kỷ niệm 5 năm ngày cưới', 'Phong' => $phongs[9], 'GiaThue' => 3200000],
